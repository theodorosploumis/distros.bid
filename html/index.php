...
<section class="wrapper">
    ...
    <div class="starters">
        ...
        <form id="submit-form" class="form" action="container.php" method="get">
            ...
            <div><sup>1</sup>Important: Sometimes, a 502 error page may appear. Please refresh the error page so you get your instance running. 
            This is usually fixed in less than a minute.</div>
            <div><sup>2</sup>Notice: Sites are available for <b>40 minutes</b>.</div>
